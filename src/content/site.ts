    ...
    skills: [
      {
        ...
        items: [
          ...
          { name: 'CRM, automação e programas de fidelidade', level: 'advanced' },
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Direção criativa e captação de vídeo', level: 'intermediate' },
    ...
    skills: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Creative direction and video shooting', level: 'intermediate' },
          { name: 'Adobe Photoshop', level: 'intermediate' },
          { name: 'Adobe Illustrator', level: 'intermediate' },
